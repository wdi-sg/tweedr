module.exports = (app, db) => {
    ...
    // app.get('/users/new', controller.new);
    // app.post('/users', controller.);

    app.get('/users/login', controller.loginUser);
    // app.post('/users/login', controller.);

    // app.get('/users/logout', controller.);
    
    // app.get('/users/profile', controller.);
    // app.post('/users/profile', controller.);
